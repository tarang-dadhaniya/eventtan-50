                    ...
                    <div class="flex flex-col gap-0">
                      ...
                      >
                        ...
                        >
                          <div class="text-center py-12">
                            <p class="text-[#878A99] text-lg">
                              No information available. Click "Add Information" to
                              get started.
                            </p>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div
                            class="text-[#353846] font-semibold text-base text-center capitalize"
                          >
                            {{ info.floorPlanFor }}
                          </div>
...
export class EventSetupComponent implements OnInit {
  ...
  loadInformation() {
    this.information = this.informationService.getInformationByEvent(this.eventId);
  }
